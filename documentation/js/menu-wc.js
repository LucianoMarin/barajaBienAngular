...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">barajabien documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/CrearProductoComponent.html" data-type="entity-link" >CrearProductoComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/EventoComponent.html" data-type="entity-link" >EventoComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/ProductoComponent.html" data-type="entity-link" >ProductoComponent</a>
                            </li>
                            <li class="link">
